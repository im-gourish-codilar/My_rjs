...
export default class NewsPopularVideos extends Component {
    render() {
        return (
            <div class="three-link-menus">
                ...
                <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.264 57.368" width="1rem" height="1rem" class="brandhub-icon">
                        <path
                ...
                <a href=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.106 30.21" width="0.7857142857142857rem"
                    height="1rem" class="brandhub-icon">
